...
- PR #80 was squash-merged as `07610f09b0c118c45cc3bd0a8781029f678e3b7d`; the repository had no GitHub Actions run for the merge commit. The merged `main` staging package passed capabilities, one-shot `js`, multiline `repl`, and exact 9-tool MCP sanity checks again.
